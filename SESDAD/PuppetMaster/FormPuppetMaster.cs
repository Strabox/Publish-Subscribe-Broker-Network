...
namespace PuppetMaster
{
    ...
    public partial class FormPuppetMaster : Form
    {
        ...
        {
            TreeView tree = sender as TreeView;
            ExecuteBackgroundTask form = new ExecuteBackgroundTask("Script Execution","Executing Script","ExecuteScriptFile",
        ...
        {
            TreeView tree = sender as TreeView;
            manager.LaunchConfigurationFile(ProcessesManager.CONFIG_FILES_DIRECTORY +
        ...
        private void FormPuppetMaster_FormClosing(object sender, FormClosingEventArgs e)
        {
            manager.CrashAll();
        }
    }
